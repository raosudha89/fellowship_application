...
{\footnotesize
\begin{itemize}
\item Scholarship to attend the \textbf{Grace Hopper Celebration} conference 2014 and 2015.
...
{\footnotesize
\begin{itemize}
\item \textbf{Languages:} Python, MATLAB, Java, C++, C\#, SQL, Perl
...
{\footnotesize
\begin{itemize}
\item \textbf{Graduate}: Computational Linguistics 1 \& 2, Multi-lingual Natural Language Processing, Prediction: Brain vs Machines, Analysis of Algorithms.
\item \textbf{Undergraduate}: Advanced Algorithms, Approximation algorithms, Intelligent systems.
\end{itemize}
}
\end{document}
